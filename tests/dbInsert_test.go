...
func TestWaermezaehlerInsert(t *testing.T) {
	...
	// Normalfall
	t.Run("WarmzaehlerInsert: ID = 19", func(t *testing.T) {
		is := is.NewRelaxed(t)
	...
	// Errortests
	t.Run("WarmzaehlerInsert: keine Gebaeudereferenzen", func(t *testing.T) {
		is := is.NewRelaxed(t)
	...
	t.Run("WarmzaehlerInsert: Zaehler vorhanden", func(t *testing.T) {
		is := is.NewRelaxed(t)
	...
	t.Run("WarmzaehlerInsert: ungueltige Gebaeudereferenz", func(t *testing.T) {
		is := is.NewRelaxed(t)
	...
	t.Run("WarmzaehlerInsert: IDEnergieversorgung = 0 nicht vorhanden", func(t *testing.T) {
		is := is.NewRelaxed(t)
